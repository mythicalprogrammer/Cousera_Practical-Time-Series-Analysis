...
birth.data <- read.csv(file="daily-total-female-births-in-cal.csv",
                        header=TRUE, sep=",")
...
plot.ts(number_of_births,main='Daily total female births in california, 1959',
        ylab = 'Number of births')

# Test for correlation
Box.test(number_of_births,
         lag = log(length(number_of_births)))
